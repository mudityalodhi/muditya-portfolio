...
import profile from "../assets/muditprofile.jpg"; // 📸 Replace with your actual image path

const About = () => {
  return (
    <section
      id="about"
      className="bg-gray-50 py-16 px-4 overflow-x-hidden"
    >
      <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="text-gray-700 text-base sm:text-lg mb-6 leading-relaxed">
            I'm Muditya Lodhi, a passionate Frontend Developer with a strong interest
            in creating elegant, fast, and accessible web applications. My journey
            began with curiosity and grew into a deep passion for crafting modern
            UIs and user-friendly experiences.
          </p>
